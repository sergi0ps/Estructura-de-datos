...
class MetodosUtilesTest {
	...
	@Test
	void testSuma() {
		int comprobación = MetodosUtiles.sumaDosNumeros(3, 2);
		assertEquals(comprobación, 5);
	}
	
	@Test
	void testEsPar() {
		boolean comprobacion = MetodosUtiles.esPar(5);
		assertFalse(comprobacion);
	}
	
	@ParameterizedTest
	@ValueSource (ints = {2,4,6} )
	void testSonPares (int numerosAComprobar) {
		boolean comprobacion = MetodosUtiles.esPar(numerosAComprobar);
		assertTrue(comprobacion);
	}
